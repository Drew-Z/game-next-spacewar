...
- [x] 首次进入单局时会显示轻量按键提示面板
- [x] 引导内容覆盖移动、射击、暂停，以及结果页中的重开 / 返回主菜单提示
- [x] 按键提示会在首次相关操作后隐藏，也会在短暂展示后自动消失
- [x] 引导加入后，主菜单、设置、About / Help、暂停、结果页、重开与返回主菜单流程仍正常
- [x] 当前已达到“首局可理解展示版”标准
- [x] 当前建议进入 review / 发布说明收口
- [x] 当前建议准备合回 `main`
...
- 当前阶段目标是补齐“首局按键提示 / 轻量引导”，不扩展复杂教程系统或多步新手引导。
- 当前 M12 已具备“可交付展示版入口说明”标准。
- 当前分支相对 `main` 的新增范围为 3 个提交：阶段 18 功能提交 + 2 个 M12 文档收口提交。
- 当前展示版已具备主菜单、设置、帮助入口、暂停返回、独立结果页与版本标识的完整入口说明闭环。
- 主线当前未落后，分支边界清晰；现在合并更有助于后续阶段继续从稳定主线展开。
- 当前更适合先 review，再通过 PR 合回 `main`，而不是继续在当前分支直接做下一阶段。
- 建议 PR 描述要点：About / Help 入口、项目说明、基础操作说明、返回后仍可正常开始游戏、当前版本达到“可交付展示版入口说明”标准。
- 当前更建议先做 review，再创建 PR；本次未执行任何 GitHub 操作。
- 当前 M13 已具备“首局可理解展示版”标准。
- 当前分支相对 `main` 的新增范围为 1 个提交：阶段 19 功能提交。
- 当前展示版已具备主菜单、设置、About / Help、首局引导、暂停、独立结果页与版本标识的完整可理解入口闭环。
- 当前更适合先进入 review / 发布说明收口，再判断是否准备合回 `main`。
